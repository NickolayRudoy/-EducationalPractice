...
function editLogin(login){
    ...
    a.innerHTML = '<span class="myName">'+login+'</span>'+
    ...
    logout.innerHTML = '<a href="/logout?username='+username+'"><span class="glyphicon glyphicon-log-out""></span>';
}
